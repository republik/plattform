...
export default ({src, srcSet, sizes, alt, aspectRatio, attributes, visible, offset, onClick}) => (
  <LazyLoad attributes={{...styles.container, ...attributes}} offset={offset} visible={visible} style={{
    ...
    <img src={src} srcSet={srcSet} sizes={sizes} alt={alt} {...styles.img} onClick={onClick} />
  </LazyLoad>
)
