...
import { query as treeQuery } from './tree'
...
class PublishForm extends Component {
  ...
  render () {
    const { t, commit, repoId } = this.props
    const {
...
const PublishFormWithMutation = compose(
  graphql(mutation, {
    props: ({mutate}) => ({
      ...
      <Loader loading={loading} error={error} render={() => {
        ...
        return (
          <div>
            ...
            <PublishFormWithMutation repoId={repoId} commit={commit} t={t} />
