...
-- Reverse the cutover: rename back to _v2, and recreate the original
-- cockpit_membership_evolution view (the one this migration dropped).
ALTER INDEX cockpit_membership_evolution_idx RENAME TO cockpit_membership_evolution_v2_idx;
ALTER MATERIALIZED VIEW cockpit_membership_evolution RENAME TO cockpit_membership_evolution_v2;
