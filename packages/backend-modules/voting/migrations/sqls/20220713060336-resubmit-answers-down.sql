...
ALTER TABLE "public"."questionnaires"
  DROP CONSTRAINT "resubmitAnswers_updateResultIncrementally_incompatibility",
  DROP CONSTRAINT "resubmitAnswers_unattributedAnswers_incompatibility",
  DROP COLUMN "resubmitAnswers";
