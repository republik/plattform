...
ALTER TABLE "public"."questionnaires"
  DROP CONSTRAINT "revokeSubmissions_unattributedAnswers_incompatibility",
  DROP CONSTRAINT "revokeSubmissions_updateResultIncrementally_incompatibility",
  DROP CONSTRAINT "revokeSubmissions_submitAnswersImmediately_incompatibility",
  DROP COLUMN "revokeSubmissions"
;
