ALTER TABLE "public"."questionnaires"
  ADD COLUMN "resubmitAnswers" boolean NOT NULL DEFAULT false,
  ADD CONSTRAINT "resubmitAnswers_updateResultIncrementally_incompatibility" CHECK (
    "resubmitAnswers" = FALSE OR
    (
      "resubmitAnswers" = TRUE AND 
      "updateResultIncrementally" = FALSE
    )
  ),
  ADD CONSTRAINT "resubmitAnswers_unattributedAnswers_incompatibility" CHECK (
    "resubmitAnswers" = FALSE OR
    (
      "resubmitAnswers" = TRUE AND 
