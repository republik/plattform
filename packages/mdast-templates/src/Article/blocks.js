...
import {
  BlockQuote,
  BlockQuoteParagraph,
} from '@project-r/styleguide/src/components/BlockQuote'

import {
  PullQuote,
  PullQuoteSource,
  PullQuoteText,
} from '@project-r/styleguide/src/components/PullQuote'

import { FIGURE_SIZES } from '@project-r/styleguide/src/components/Figure'
...
import {
  ...
  InfoBoxText,
  InfoBoxTitle,
} from '@project-r/styleguide/src/components/InfoBox'
