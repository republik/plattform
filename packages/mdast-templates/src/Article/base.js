import globalMediaState, {
  parseTimeHash,
} from '@project-r/styleguide/src/lib/globalMediaState'
...
import { slug } from '@project-r/styleguide/src/lib/slug'
...
import { ExpandableLink } from '@project-r/styleguide/src/components/ExpandableLink'
import { SEPARATOR as EXPANDABLE_LINK_SEPARATOR } from '@project-r/styleguide/src/components/ExpandableLink/ExpandableLink'
import { MIN_GALLERY_IMG_WIDTH } from '@project-r/styleguide/src/components/Figure/Image'
import {
  extractImages,
  getDisplayWidth,
  globalInlines,
