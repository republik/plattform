...
const { GITHUB_APP_ID, GITHUB_APP_KEY, GITHUB_INSTALLATION_ID } = process.env
...
const getInstallationToken = async () => {
  checkEnv(['GITHUB_APP_ID', 'GITHUB_APP_KEY', 'GITHUB_INSTALLATION_ID'])
