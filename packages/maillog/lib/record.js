...
const getSubject = (record) =>
  record.info && record.info.message && record.info.message.subject
...
const getError = (record) =>
  (record.mandrillLastEvent &&
    record.mandrillLastEvent.msg &&
    record.mandrillLastEvent.msg.diag) ||
  (record.mandrillLastEvent &&
    record.mandrillLastEvent.msg &&
    record.mandrillLastEvent.msg.bounce_description) ||
