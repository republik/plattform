...
import { Editorial } from './__styleguide/components/Typography'
...
export const Scrolly = () => {
  // TODO: useResolvedColorSchemeKey currently lives in app/www
  ...
  return (
    <div className='Scrolly' {...styles.scrolly}>
      ...
      >
        ...
        <Editorial.P attributes={{}}>Und die CS?</Editorial.P>
      </ScrollySlide>
