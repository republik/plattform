...
export const linkPreview2 = {
  ...
  text: '@tpreusse @adfichter Helfen Sie mit, die nächsten #2JahreRepublik zu ermöglichen? So langsam finden wir, das lohnt sich. 😉\n\nhttp://www.republik.ch/cockpit',
  html: '<a href="https://twitter.com/tpreusse" target="_blank" rel="noopener noreferrer">@tpreusse</a> <a href="https://twitter.com/adfichter" target="_blank" rel="noopener noreferrer">@adfichter</a> Helfen Sie mit, die nächsten #2JahreRepublik zu ermöglichen? So langsam finden wir, das lohnt sich. 😉<br/><br/><a href="http://www.republik.ch/cockpit" target="_blank" rel="noopener noreferrer">republik.ch/cockpit</a>',
  userName: 'Republik',
