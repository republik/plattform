                    ...
                    pages: [
                      {
                        ...
                        imports: {
                          ...
                          renderMdast:
                            require('mdast-react-render').renderMdast,
                        },
                      ...
                      },
                      {
                        ...
                        imports: {
                          webSchema:
                            require('./templates/Comment/web').default(),
                          emailSchema:
                    ...
                    pages: [
                      {
                        path: '/charts',
                        title: 'Overview',
                        component: require('./components/Chart/docs.js')
                          .default,
                      },
                      {
                        path: '/charts/editor',
                      ...
                      },
                      {
                        ...
                        imports: {
                          ...
                          ChartLegend:
                            require('./components/Chart').ChartLegend,
                          CsvChart: require('./components/Chart/Csv'),
                          t,
                        },
                    ...
                    pages: [
                      {
                        path: '/editor',
                        title: 'Docs',
                        src: require('./components/Editor/docs/index.md'),
                      },
                      {
                        ...
                        src: require('./components/Editor/docs/community.md'),
                      },
                      {
                        path: '/editor/flyer',
                        title: 'Flyer',
