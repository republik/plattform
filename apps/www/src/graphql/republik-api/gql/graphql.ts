...
export type CallToActionPayload =
  | CallToActionBasicPayload
  | CallToActionComponentPayload
...
export type MutationsUpdateNotificationSettingsArgs = {
  ...
  discussionNotificationChannels?: InputMaybe<
    Array<DiscussionNotificationChannel>
  >
}
...
export type PendingAppSignInQuery = {
  __typename?: 'queries'
  pendingAppSignIn?: {
    __typename?: 'SignInNotification'
    title: string
...
export type AcknowledgeCtaMutation = {
  __typename?: 'mutations'
...
export type MeQuery = {
  ...
  me?: {
    ...
    prolongBeforeDate?: string | null
    accessCampaigns?: Array<{
      __typename?: 'AccessCampaign'
      id: string
    }> | null
    activeMembership?: {
      ...
      canProlong: boolean
      type: { __typename?: 'MembershipType'; name: string }
    } | null
  } | null
}
...
export type SignUpForNewsletterMutation = {
  __typename?: 'mutations'
  requestNewsletterSubscription: boolean
}

export type CaNewsletterQueryQueryVariables = Exact<{
  name: NewsletterName
}>

export type CaNewsletterQueryQuery = {
  __typename?: 'queries'
  me?: {
    __typename?: 'User'
    newsletterSettings: {
...
export const PendingAppSignInDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'PendingAppSignIn' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'verificationUrl' },
                },
...
>
export const ArticleTeaserDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'articleTeaser' },
      variableDefinitions: [
        {
...
} as unknown as DocumentNode<ArticleTeaserQuery, ArticleTeaserQueryVariables>
export const AcknowledgeCtaDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'acknowledgeCTA' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'acknowledgeCallToAction' },
            arguments: [
              {
                kind: 'Argument',
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'acknowledgedAt' },
                },
              ],
            },
          },
  ...
  AcknowledgeCtaMutation,
  AcknowledgeCtaMutationVariables
>
export const MyCallToActionsDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'myCallToActions' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'portrait' } },
                ...
                },
                {
                  ...
                  name: {
                    kind: 'Name',
                    value: 'discussionNotificationChannels',
                  },
                },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'accessCampaigns' },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      { kind: 'Field', name: { kind: 'Name', value: 'id' } },
                ...
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'hasDormantMembership' },
                },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'prolongBeforeDate' },
                },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'activeMembership' },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      { kind: 'Field', name: { kind: 'Name', value: 'id' } },
                      ...
                      { kind: 'Field', name: { kind: 'Name', value: 'renew' } },
                      {
                        kind: 'Field',
                      ...
                      {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'graceEndDate' },
                      },
                      {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'canProlong' },
                      },
                    ],
                  },
                },
...
export const SignUpForNewsletterDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'SignUpForNewsletter' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
        ...
        },
        {
          ...
          type: {
            ...
            type: {
              kind: 'NamedType',
              name: { kind: 'Name', value: 'NewsletterName' },
            },
          },
        },
        {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'requestNewsletterSubscription' },
            arguments: [
              {
                kind: 'Argument',
                name: { kind: 'Name', value: 'email' },
  ...
  SignUpForNewsletterMutation,
  SignUpForNewsletterMutationVariables
>
export const CaNewsletterQueryDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'CANewsletterQuery' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'name' } },
  ...
  CaNewsletterQueryQuery,
  CaNewsletterQueryQueryVariables
>
export const UpdateNewsletterSubscriptionDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'updateNewsletterSubscription' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'name' } },
