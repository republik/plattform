...
export type PersonDetailQuery = { __typename?: 'Query', person?: { __typename?: 'PersonRecord', id: number, name: string, portrait?: { __typename?: 'FileField', alt?: string | null, url: string, width?: number | null, height?: number | null, title?: string | null } | null, items: Array<{ __typename: 'ArticleRecord', id: number, path: string, image?: { __typename?: 'FileField', url: string } | null } | { __typename: 'EventRecord', id: number, title: string, isPublic?: any | null, nonMemberCta?: string | null, location: string, startAt: string, endAt?: string | null, signUpLink: string, description?: { __typename?: 'EventModelDescriptionField', value: any } | null } | { __typename: 'NewsletterRecord', id: number, path: string }> } | null };
