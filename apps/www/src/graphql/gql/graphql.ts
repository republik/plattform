...
export type MarketingLandingPageQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type MarketingLandingPageQueryQuery = { __typename?: 'Query', marketingLandingPage?: { __typename?: 'MarketingLandingPageRecord', id: number, sectionTeamTitle: string, sectionTeamDescription: string, sectionDialogTitle: string, sectionDialogDescription: string, sectionFormatsTitle: string, sectionFormatsDescription: string, reasons: Array<{ __typename?: 'MarketingReasonRecord', title: string, description: string }>, formats: Array<{ __typename?: 'MarketingFormatRecord', titel: string, description: string, imageDark: { __typename?: 'FileField', responsiveImage?: { __typename?: 'ResponsiveImage', src: string } | null }, imageBright: { __typename?: 'FileField', responsiveImage?: { __typename?: 'ResponsiveImage', src: string } | null }, color: { __typename?: 'ColorField', hex: string } }> } | null };
