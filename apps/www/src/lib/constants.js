...
export const TYPESENSE_PORT = +process.env.NEXT_PUBLIC_TYPESENSE_PORT || 443
export const TYPESENSE_PROTOCOL =
  process.env.NEXT_PUBLIC_TYPESENSE_PROTOCOL || 'https'
export const TYPESENSE_COLLECTION_PREFIX =
  process.env.NEXT_PUBLIC_TYPESENSE_COLLECTION_PREFIX || 'republik'
