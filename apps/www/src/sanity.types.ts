...
// Query: *[    _type == "article" &&    defined(slug.current) &&    defined(publishDate) &&    defined(audioSourceMp3) &&    (      !defined($lastPublishDate) ||      publishDate < $lastPublishDate ||      (publishDate == $lastPublishDate && _id > $lastId)    )  ] | order(publishDate desc, _id asc) [0...$limit] {      _id,  "title": pt::text(title),  "slug": slug.current,  publishDate,  audioSourceMp3,  audioDurationMs,  syntheticVoiceEnabled,  "image": teaserSmall.image  }
