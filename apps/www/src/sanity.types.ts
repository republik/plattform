...
// Query: *[_type == "article" && slug.current == $slug][0]{    _id,    title,    description,    byline,    cover {      ...    },    heading->{      _id,      title,      "slug": slug.current    },    newsletter->{      title,      description,      frequency,      image,      name,    },    theme {      darkMode,      accentColor    },      content[]{    ...,    markDefs[]{      ...,      _type == "internalLink" => {        "slug": @.reference->slug      }    }  },    contributors[]{      _id,      kind,      "slug": contributor->userId,      "name": contributor->title,      "description": contributor->description,      "portrait": contributor->portrait    },    "articleCollection": articleCollections[0]->{      _id,      title,      description,      image    },    articleRecommendations[]->{        _id,  _type,  title,  description,  slug,  image,  heading->{    _id,    title,    slug,  },  theme{    accentColor  },  contributors[]{    kind,    "name": contributor->title,  }    }  }
...
// Query: *[(_type == "article" || _type == "page") && slug.current == $slug][0]{      _type,  "slug": slug.current,  heading->{    _id,    title,    slug,  },  theme {    titleFont,    accentColor  },  contributors[]{    kind,    "name": contributor->title,  },  "teaser": frontTeaser {    layout,    title,    lead,    image,    imageCredits,    imagePosition,    imagePadding,    textPosition,    textSize,    color,    backgroundColor  }  }
...
// Query: *[_type == "article" && defined(slug.current)][0...100]{      _id,  _type,  title,  description,  slug,  image,  heading->{    _id,    title,    slug,  },  theme{    accentColor  },  contributors[]{    kind,    "name": contributor->title,  }  }
...
// Source: src/app/(sanity)/groq/carousel-block-query.ts
// Variable: CAROUSEL_BLOCK_QUERY
// Query: *[_type == "page" && _id == $documentId][0]{    "block": pageBuilder[_key == $blockKey][0]{      "teasers": select(        source.sourceType == "MANUAL" => source.items[$start...$end]->{            _id,  _type,  "title": coalesce(shortTitle, title),  "description": coalesce(shortLead, description),  slug,  image,  publishDate,  heading->{    _id,    title,    slug,  },  theme{    accentColor  },        },        source.sourceType == "COLLECTION" => *[          _type == "article" &&          ^.source.collection._ref in articleCollections[]._ref        ] | order(publishDate desc) [$start...$end] {            _id,  _type,  "title": coalesce(shortTitle, title),  "description": coalesce(shortLead, description),  slug,  image,  publishDate,  heading->{    _id,    title,    slug,  },  theme{    accentColor  },        }, []      ),    }  }
export type CAROUSEL_BLOCK_QUERY_RESULT = {
  block:
    | {
        teasers:
          | Array<{
...
// Source: src/app/(sanity)/groq/carousel-teaser-fragment.ts
// Variable: CAROUSEL_TEASER_FRAGMENT_QUERY
// Query: *[_type in ["article", "page"]]{      _id,  _type,  "title": coalesce(shortTitle, title),  "description": coalesce(shortLead, description),  slug,  image,  publishDate,  heading->{    _id,    title,    slug,  },  theme{    accentColor  },  }
export type CAROUSEL_TEASER_FRAGMENT_QUERY_RESULT = Array<
  | {
      _id: string
      _type: 'article'
      title: InlineEditor
...
// Source: src/app/(sanity)/groq/feed-block-query.ts
// Variable: FEED_BLOCK_QUERY
// Query: *[_type == "page" && _id == $documentId][0]{    "block": pageBuilder[_key == $blockKey][0]{      "teasers": select(        source.sourceType == "MANUAL" => source.items[$start...$end]->{            _id,  _type,  title,  description,  slug,  image,  heading->{    _id,    title,    slug,  },  theme{    accentColor  },  contributors[]{    kind,    "name": contributor->title,  }        },        source.sourceType == "COLLECTION" => *[          _type == "article" &&          ^.source.collection._ref in articleCollections[]._ref        ] | order(publishDate desc) [$start...$end] {            _id,  _type,  title,  description,  slug,  image,  heading->{    _id,    title,    slug,  },  theme{    accentColor  },  contributors[]{    kind,    "name": contributor->title,  }        }, []      ),    }  }
export type FEED_BLOCK_QUERY_RESULT = {
  block:
    | {
        teasers:
          | Array<{
...
// Source: src/app/(sanity)/groq/feed-teaser-fragment.ts
// Variable: FEED_TEASER_FRAGMENT_QUERY
// Query: *[_type in ["article", "page"]]{      _id,  _type,  title,  description,  slug,  image,  heading->{    _id,    title,    slug,  },  theme{    accentColor  },  contributors[]{    kind,    "name": contributor->title,  }  }
export type FEED_TEASER_FRAGMENT_QUERY_RESULT = Array<
  | {
      _id: string
      _type: 'article'
      title: InlineEditor
...
// Query: *[_type in ["article", "page"]][0]{      _type,  "slug": slug.current,  heading->{    _id,    title,    slug,  },  theme {    titleFont,    accentColor  },  contributors[]{    kind,    "name": contributor->title,  },  "teaser": frontTeaser {    layout,    title,    lead,    image,    imageCredits,    imagePosition,    imagePadding,    textPosition,    textSize,    color,    backgroundColor  }  }
...
// Variable: PAGE_QUERY
// Query: *[_type == "page" && slug.current == $slug][0]{    _id,    title,    cover {      ...    },    skipTitleBlock,    useCoverAsTitle,    heading->{      _id,      title,      "slug": slug.current    },    theme {      darkMode,      accentColor    },    pageBuilder[]{      _key,      _type,      _type == "menu" => {          hasSeparator,  heading {    title,    page->{      _id,      "title": pt::text(title),      "slug": slug.current    }  },  pages[]{    _key,    _type,    _type == "link" => {      href,      title    },    _type == "reference" => {      "page": @->{        _id,        "title": pt::text(title),        "slug": slug.current      }    }  }      },      _type == "callToAction" => {          target->{    _id,    _type,    _type == "newsletter" => {      name,      title    },    _type == "podcast" => {      podigeeSlug,      spotifyUrl,      appleUrl    },    _type == "articleCollection" => {      title,      description    }  }      },      _type == "editorBlock" => {          content[]{    ...,    markDefs[]{      ...,      _type == "internalLink" => {        "slug": @.reference->slug      }    }  }      },      _type == "teaserList" => {          appearance,  maxItems,  title,  "total": select(    source.sourceType == "MANUAL" => count(source.items),    source.sourceType == "COLLECTION" => count(*[      _type == "article" &&      ^.source.collection._ref in articleCollections[]._ref    ]),    0  )      },      _type == "frontTeaser" => {        "reference": @->{  _type,  "slug": slug.current,  heading->{    _id,    title,    slug,  },  theme {    titleFont,    accentColor  },  contributors[]{    kind,    "name": contributor->title,  },  "teaser": frontTeaser {    layout,    title,    lead,    image,    imageCredits,    imagePosition,    imagePadding,    textPosition,    textSize,    color,    backgroundColor  }}      },    }  }
...
// Query: *[_type == "page"][0]{    "block": pageBuilder[_type == "editorBlock"][0]{        content[]{    ...,    markDefs[]{      ...,      _type == "internalLink" => {        "slug": @.reference->slug      }    }  }    }  }
...
// Source: src/app/(sanity)/groq/teaser-block-fragment.ts
// Variable: TEASER_BLOCK_FRAGMENT
// Query: reference -> {    _type,  "slug": slug.current,  heading->{    _id,    title,    slug,  },  theme {    titleFont,    accentColor  },  contributors[]{    kind,    "name": contributor->title,  },  "teaser": frontTeaser {    layout,    title,    lead,    image,    imageCredits,    imagePosition,    imagePadding,    textPosition,    textSize,    color,    backgroundColor  }  }
export type TEASER_BLOCK_FRAGMENT_RESULT = never

// Source: src/app/(sanity)/groq/teaser-block-fragment.ts
// Variable: TEASER_BLOCK_FRAGMENT_QUERY
// Query: *[_type == "page"][0]{    "block": pageBuilder[_type == "teaserItem"][0]{      reference -> {    _type,  "slug": slug.current,  heading->{    _id,    title,    slug,  },  theme {    titleFont,    accentColor  },  contributors[]{    kind,    "name": contributor->title,  },  "teaser": frontTeaser {    layout,    title,    lead,    image,    imageCredits,    imagePosition,    imagePadding,    textPosition,    textSize,    color,    backgroundColor  }  }    }  }
export type TEASER_BLOCK_FRAGMENT_QUERY_RESULT = {
  block: null
} | null

// Source: src/app/(sanity)/groq/teaser-list-block-fragment.ts
// Variable: TEASER_LIST_BLOCK_FRAGMENT_QUERY
// Query: *[_type == "page"][0]{    "block": pageBuilder[_type == "teaserList"][0]{        appearance,  maxItems,  title,  "total": select(    source.sourceType == "MANUAL" => count(source.items),    source.sourceType == "COLLECTION" => count(*[      _type == "article" &&      ^.source.collection._ref in articleCollections[]._ref    ]),    0  )    }  }
...
declare module '@sanity/client' {
  interface SanityQueries {
    ...
    'reference -> {\n  \n  _type,\n  "slug": slug.current,\n  heading->{\n    _id,\n    title,\n    slug,\n  },\n  theme {\n    titleFont,\n    accentColor\n  },\n  contributors[]{\n    kind,\n    "name": contributor->title,\n  },\n  "teaser": frontTeaser {\n    layout,\n    title,\n    lead,\n    image,\n    imageCredits,\n    imagePosition,\n    imagePadding,\n    textPosition,\n    textSize,\n    color,\n    backgroundColor\n  }\n\n  }': TEASER_BLOCK_FRAGMENT_RESULT
    '*[_type == "page"][0]{\n    "block": pageBuilder[_type == "teaserItem"][0]{\n      reference -> {\n  \n  _type,\n  "slug": slug.current,\n  heading->{\n    _id,\n    title,\n    slug,\n  },\n  theme {\n    titleFont,\n    accentColor\n  },\n  contributors[]{\n    kind,\n    "name": contributor->title,\n  },\n  "teaser": frontTeaser {\n    layout,\n    title,\n    lead,\n    image,\n    imageCredits,\n    imagePosition,\n    imagePadding,\n    textPosition,\n    textSize,\n    color,\n    backgroundColor\n  }\n\n  }\n    }\n  }': TEASER_BLOCK_FRAGMENT_QUERY_RESULT
