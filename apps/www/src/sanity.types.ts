...
export type TeaserSmall = {
  ...
  _updatedAt: string;
  _rev: string;
  target?: Array<ArticleReference | PageReference | {
    _key: string;
  } & Link>;
  collection?: ArticleCollectionReference;
...
export type TeaserLarge = {
  ...
  textPosition?: "TOP" | "MIDDLE" | "BOTTOM" | "TOP_LEFT" | "TOP_RIGHT" | "BOTTOM_LEFT" | "BOTTOM_RIGHT" | "UNDERNEATH";
...
export type ArticleTemplate = {
  ...
  syntheticVoice?: "huebsch-311-054-rpblk" | "huebsch-62964-rpblk" | "huebsch-714-109-rpblk" | "huebsch-82170-rpblk" | "huebsch-285-169-rpblk" | "huebsch-gen-female-e-rpblk" | "huebsch-01150-rpblk" | "huebsch-01150" | "huebsch-62964" | "huebsch-08316" | "huebsch-01670";
...
export type VoiceTag = {
  _type: "voiceTag";
  voice: "huebsch-311-054-rpblk" | "huebsch-62964-rpblk" | "huebsch-714-109-rpblk" | "huebsch-82170-rpblk" | "huebsch-285-169-rpblk" | "huebsch-gen-female-e-rpblk" | "huebsch-01150-rpblk" | "huebsch-01150" | "huebsch-62964" | "huebsch-08316" | "huebsch-01670";
};
...
export type DynamicComponent = {
  ...
  size?: "NORMAL" | "BREAKOUT" | "FULL";
  src?: string;
  identifier?: "MANIFEST" | "TEAM_TEASER" | "REASONS_VIDEO" | "VOTEBOX" | "VOTE_COUNTER" | "VOTE_RESULT" | "TESTIMONIAL_LIST" | "ELECTION_CANDIDACY" | "ELECTION" | "ELECTION_RESULT" | "ELECTION_RESULT_DIVERSITY" | "INSTANT_SURVEY" | "QUESTIONNAIRE" | "QUESTIONNAIRE_SUBMISSIONS" | "QUESTIONNAIRE_OVERVIEW" | "EDGE_QUESTION" | "NEWSLETTER_SIGNUP" | "CLIMATE_LAB_COUNTER" | "CLIMATE_LAB_INLINE_TEASER" | "POSTCARD" | "POSTCARD_GALLERY" | "CHALLENGE_ACCEPTED_INLINE_TEASER" | "COMPACT_DETAILS_FORM" | "TRIAL_FORM";
  props?: Code;
  autoHtml?: boolean;
  html?: Code;
};
...
export type Page = {
  ...
  theme?: Theme;
  slugSegment?: string;
  slugTemplate?: "{{segment}}-{{title}}" | "{{title}}-{{segment}}" | "{{segment}}";
};
...
export type AllSanitySchemaTypes = LegacyAudioSrc | Src | EmbedCommentDiscussion | ChartConfig | SanityImageAssetReference | ImageDark | AudioCover | AudioCoverCrop | AudioGenerationResult | ContributorsSyncResult | ArticleCollectionReference | ArticleReference | PageReference | TeaserSmallReference | Source | Heading | TeaserSmall | TeaserSmallConfig | TeaserLarge | SanityImageCrop | SanityImageHotspot | Color | InlineEditor | TextOnlyInlineEditor | TeaserLargeReference | Front | SanityFileAssetReference | NewsletterReference | PodcastReference | ArticleTemplate | Slug | AudioVersion | LogEntry | SignOff | ContributorReference | ContributorEntry | LegacyMeta | Mdast | NestedEditor | TextOnlyEditor | PlainTextInlineEditor | PageEditor | ArticleEditor | Caption | VoiceTag | InternalLink | ExpandableLink | DiscussionReference | Article | Discussion | Theme | EditorialImage | Seo | Link | Variable | IfNot | If | EmailOnly | WebOnly | PullQuote | BlockQuote | InfoBox | AuthorBlock | Contributor | Button | SeriesNav | Toc | StoryComponent | DynamicComponent | Html | EmbedComment | EmbedDataWrapper | EmbedTwitter | Audio | EmbedVideo | Chart | DividerStars | Divider | ImageGroup | GroupedEditorialImage | AsideImage | EditorBlock | CallToAction | Podcast | Newsletter | Menu | Page | Code | MyRepublik | BestOfDialogue | TeaserList | ArticleCollection | SeoImageBuilder | MediaTag | RgbaColor | HsvaColor | HslaColor | SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | SanityImageMetadata | SanityFileAsset | SanityAssetSourceData | SanityImageAsset | Geopoint;
...
export type TEASER_LARGE_QUERY_RESULT = {
  ...
  teaser: {
    ...
    textPosition: "BOTTOM_LEFT" | "BOTTOM_RIGHT" | "BOTTOM" | "MIDDLE" | "TOP_LEFT" | "TOP_RIGHT" | "TOP" | "UNDERNEATH" | null;
...
// Source: src/app/(sanity)/groq/collections-query.ts
// Variable: COLLECTIONS_QUERY
// Query: *[_type == "articleCollection" && _id in $ids]{    _id,    title,    description,    image  }
...
export type DOCUMENT_BY_SLUG_QUERY_RESULT = {
  ...
  content: Array<{
    ...
    size?: "BREAKOUT" | "FULL" | "NORMAL";
    src?: string;
    identifier?: "CHALLENGE_ACCEPTED_INLINE_TEASER" | "CLIMATE_LAB_COUNTER" | "CLIMATE_LAB_INLINE_TEASER" | "COMPACT_DETAILS_FORM" | "EDGE_QUESTION" | "ELECTION_CANDIDACY" | "ELECTION_RESULT_DIVERSITY" | "ELECTION_RESULT" | "ELECTION" | "INSTANT_SURVEY" | "MANIFEST" | "NEWSLETTER_SIGNUP" | "POSTCARD_GALLERY" | "POSTCARD" | "QUESTIONNAIRE_OVERVIEW" | "QUESTIONNAIRE_SUBMISSIONS" | "QUESTIONNAIRE" | "REASONS_VIDEO" | "TEAM_TEASER" | "TESTIMONIAL_LIST" | "TRIAL_FORM" | "VOTE_COUNTER" | "VOTE_RESULT" | "VOTEBOX";
    props?: Code;
    autoHtml?: boolean;
    html?: Code;
    markDefs: null;
...
// Query: *[_type == "page"][0]{    "block": pageBuilder[_type == "menu"][0]{        hasSeparator,  heading {    title,    page->{      _id,      "title": pt::text(title),      "slug": slug.current    }  },  pages[]{    _key,    _type,    _type == "link" => {      href,      title    },    _type == "reference" => {      "page": @->{        _id,        "title": pt::text(title),        "slug": slug.current,        "color": theme.accentColor.hex      }    }  }    }  }
