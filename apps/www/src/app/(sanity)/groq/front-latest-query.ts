...
import type { FRONT_LATEST_QUERY_RESULT } from '@/sanity.types'
import { defineQuery } from 'next-sanity'

// The front is a singleton-ish document; render the most recently published one.
export const FRONT_LATEST_QUERY = defineQuery(
...
export type FrontBuilderBlock =
  | NonNullable<NonNullable<FRONT_LATEST_QUERY_RESULT>['pageBuilder']>[number]
