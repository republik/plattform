      ...
      >
        ...
        <Message
          lines={
            sender
              ? [
                  `«Unabhängigen Journalismus gibt es, weil wir etwas dafür tun. Darum unterstütze
          ich die Republik.`,
                  `Du auch?»`,
                ]
              : [`Die Republik gibt es, weil wir etwas dafür tun.`, `Du auch?`]
          }
        />
        ...
        >
          ...
          <div style={{ display: 'flex' }}>
            ...
            >
              {`republik.ch/jetzt/${sender?.username ?? params.code}`}
            </div>
          </div>
        </div>
