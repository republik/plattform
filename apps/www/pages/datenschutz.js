...
Mit dem Anklicken der Checkbox erklären die betroffenen Personen ihr Einverständnis mit der vorliegenden Datenschutzerklärung.
...
1. Sollten Sie sich im Rahmen Ihres Bestellvorgangs für eine Bezahlung mit dem Online-Zahlungsdienstleister PayPal entscheiden, werden im Rahmen der so ausgelösten Bestellung Ihre Kontaktdaten an PayPal übermittelt. PayPal ist ein Angebot der PayPal (Europe) S.à.r.l. & Cie. S.C.A., 22-24 Boulevard Royal, L-2449 Luxembourg.
2. Bei den an PayPal übermittelten personenbezogenen Daten handelt es sich zumeist um Vorname, Nachname, Adresse, Telefonnummer, IP-Adresse, E-Mail-Adresse oder andere Daten, die zur Bestellabwicklung erforderlich sind, wie auch Daten, die im Zusammenhang mit der Bestellung stehen. Diese Übermittlung ist zur Abwicklung Ihrer Bestellung mit der von Ihnen ausgewählten Zahlungsart notwendig, insbesondere zur Bestätigung Ihrer Identität, zur Administration Ihrer Zahlung und der Kundenbeziehung.
3. Bitte beachten Sie jedoch, dass PayPal personenbezogene Daten auch an weitere Auftragsverarbeiter weitergeben wird, soweit dies zur Erfüllung der vertraglichen Verpflichtungen aus Ihrer Bestellung erforderlich ist.
4. Abhängig von der über PayPal ausgewählten Zahlungsart, z. B. Rechnung oder Lastschrift, werden die an PayPal übermittelten personenbezogenen Daten von PayPal an Wirtschaftsauskunfteien übermittelt. Diese Übermittlung dient der Identitäts- und Bonitätsprüfung in Bezug auf die von Ihnen getätigte Bestellung. Weitere Informationen zu PayPal erhalten Sie [hier](https://www.paypal.com/de/webapps/mpp/ua/privacy-full). 
...
## 8. Kommentar- und Debattierfunktion auf der Internetseite
...
export default withDefaultSSR(PrivacyPage)
