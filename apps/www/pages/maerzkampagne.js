  ...
  return (
    ...
    >
      ...
      >
        ...
        <>
          <P>
            Damit Sie uns vertrauen können, machen wir ein paar Dinge anders.
            Zum Beispiel sind wir komplett werbefrei. Und kompromisslos in der
            Qualität.
          </P>
          <P>
        ...
        <>
          ...
          <P>
            Wir recherchieren, fragen nach, ordnen ein und decken auf. Und
            liefern Ihnen Fakten und Zusammenhänge als Grundlage für Ihre
            eigenen Überlegungen und Entscheidungen.
          </P>
          <P>
          ...
          <P>
            Weil Vertrauen im Journalismus die härteste Währung ist, haben wir
            die Republik so aufgestellt, dass wir diese Aufgabe für Sie
          ...
          <P>
            ...
            angebrachten Sorgfalt und Hartnäckigkeit zu recherchieren. Und es
            gibt drei Dinge, an denen uns besonders viel liegt: Gute Sprache.
            Gute Bilder. Und gutes Design.
          </P>
          <P>
            <strong style={{ ...fontStyles.serifBold }}>
            ...
            wie wir Geschichten erzählen können, sondern auch den direkten
            Dialog mit Ihnen. Damit die Republik mit Ihrer Stimme vielfältiger,
          ...
          <P>
            Wir haben nur einen einzigen Kunden: Sie. Als Leserinnen. Als
            Bürger. Als Menschen, die bereit sind, etwas Geld in unabhängigen
          ...
          <P>
            ...
            rund 24’000 Mitglieder. Dieses Ziel wollen wir in den nächsten
            Jahren gemeinsam mit möglichst vielen von Ihnen erreichen.
          </P>
          <P>
          ...
          <Editorial.OL>
            ...
            <Editorial.LI>
              ...
              Beispiel zum Bündner Baukartell oder zu Missständen bei der
              grössten Kita-Kette der Schweiz – löst die Republik nicht nur
              Debatten aus, sondern auch konkrete politische Reaktionen.
            </Editorial.LI>
            ...
            <Editorial.LI>
              ...
              über 1000 Freunde und Komplizen helfen mit, unseren Journalismus
              in jeden Winkel der Schweiz zu bringen.
            </Editorial.LI>
          </Editorial.OL>
          <P>
        ...
        <Content>
          <>
            ...
            <P>
              ...
              Newsletter, im Web oder in der App. Das Konzept ist einfach:
              Einordnung und Vertiefung statt einer Flut von Nachrichten.
            </P>
            ...
            <P>
              ...
              besonders intensiv die Folgen des Aufstiegs autoritärer Politik
              für die Demokratie.
            </P>
            ...
            <P>
              ...
              Bildern, Illustrationen, Grafiken. Manchmal interaktiv. Manchmal
              als Podcast. Oder auch als Veranstaltung.
            </P>
            ...
            <P>
              Die Republik bietet ein vielfältiges Programm an Themen,
              Autorinnen und Formaten. Und Sie entscheiden selbst, wie Sie die
              Republik nutzen möchten: täglich, wöchentlich oder unregelmässig;
              alles oder nur ausgewählte Beiträge, aktiv im Dialog mit anderen
              oder einfach ganz für sich allein einen Podcast geniessen.
            </P>

            <P>
              Sie können Beiträge, die Sie besonders freuen oder ärgern,
              jederzeit mit Ihren Freunden teilen, selbst wenn diese kein Abo
              haben. Alle Beiträge der Republik sind frei teilbar, damit unser
              Journalismus möglichst viele Menschen erreicht.
            </P>

            <P>
              Und einen entscheidenden Unterschied machen kann. Die Republik ist
              politisch nicht festgelegt, aber keineswegs neutral: Sie steht
              gegen die Diktatur der Angst. Und für die Werte der Aufklärung:
              für Klarheit im Stil, Treue zu Fakten, für Lösungen von Fall zu
              Fall, für Offenheit gegenüber Kritik, Respektlosigkeit vor der
              Macht und Respekt vor dem Menschen.
            </P>
        ...
        <Content>
          <>
            ...
            <P>
              ...
              Funktion in einer Demokratie auszuüben: den Mächtigen auf die
              Finger zu schauen, unabhängig zu recherchieren und Missstände
              aufzudecken.
            </P>
            ...
            <P>
              ...
              Redaktionen auf Kosten der Qualität und Vielfalt. Seit 2011 sind
              in der Schweiz unter dem Strich mehr als 3000 Stellen im
              Journalismus verschwunden. (Das ist viel: damit könnte man 100
              Republiken machen.
            </P>
            ...
            <P>
              Als Antwort auf diese Entwicklungen – und aus Leidenschaft für
              guten Journalismus – bauen wir die Republik auf.
            </P>

            <P>
              Einerseits als konkreten Beitrag zur Vielfalt. Mit einem Medium,
              das Unabhängigkeit konsequent ernst nimmt. Andererseits auch als
              Labor für den Journalismus des 21. Jahrhunderts. Dafür ist es
              notwendig, ein funktionierendes Geschäftsmodell zu entwickeln.
            </P>

            <P>
              Eine Republik baut niemand alleine, sondern nur viele gemeinsam.
              Wir mit Ihnen?
            </P>
          </>
          <br />
