...
export const WEEK_TEMPLATE_REPOS = ENV.WEEK_TEMPLATE_REPOS

export const UNCOMMITTED_CHANGES_POLL_INTERVAL_MS =
  +ENV.UNCOMMITTED_CHANGES_POLL_INTERVAL_MS || 0

export const GHOST_PRODUCER = ENV.GHOST_PRODUCER

export const MILESTONES_POLL_INTERVAL_MS = +ENV.MILESTONES_POLL_INTERVAL_MS || 0
